...
csvwrite(strcat('out1_LeakyReLU_4_',num2str(hn1),'.csv'),char(out1));
...
csvwrite(strcat('out2_LeakyReLU_4_',num2str(hn1),'.csv'),char(out2));
...
csvwrite(strcat('out3_LeakyReLU_4_',num2str(hn1),'.csv'),char(out3));
...
csvwrite(strcat('out4_LeakyReLU_4_',num2str(hn1),'.csv'),char(out4));
...
%% save data
csvwrite(strcat('final_bounds_LeakyReLU_4',num2str(hn1),'.csv'),[final_lower,final_upper]);

csvwrite(strcat('out_LeakyReLU_4',num2str(hn1),'.csv'),char(out));
